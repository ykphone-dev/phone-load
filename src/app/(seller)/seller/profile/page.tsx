    ...
    <div className="max-w-3xl space-y-8">
      <div>
        ...
        <p className="text-sm text-zinc-500">
          상호·대표자·사업자등록번호 등 사업자 정보는 변경할 수 없습니다. 변경이
          필요하면 고객센터에 문의하세요.
        </p>
      </div>
      ...
      <KeyValueList
        items={[
          ...
          {
            label: "사업장 주소",
            value: `${seller.address}${seller.addressDetail ? ` ${seller.addressDetail}` : ""}`,
          },
          {
            label: "담당자",
          ...
          {
            label: "사업자등록증",
            value: seller.businessLicenseUrl ? "제출됨" : "미제출",
          },
          {
            label: "통신판매업 신고증",
            value: seller.mailOrderLicenseUrl ? "제출됨" : "미제출",
          },
